  ...
  switch (errorsNumber) {
    ...
    case 1:
      ...
      helpResult.textContent =
        "Rentetez une autre réponse dans la case rouge, puis re-validez";
      markResult.style.display = "block";
      markResult.innerHTML = "Score : <span>4/5<span>";
      break;

    case 2:
      titleResult.textContent = "Encore un effor...";
      helpResult.style.display = "block";
      helpResult.textContent =
        "Rentetez une autre réponse dans la case rouge, puis re-validez";
      markResult.style.display = "block";
...
const questions = document.querySelectorAll("#checkbox");
